    ...
    <div class="switcher">
      ...
      <Teleport to="body">
        ...
        >
          ...
          <div class="mt-4">
            <label class="block text-sub mb-2">{{ $t("LABELS.amount") }}</label>
            <input
              type="number"
              v-model="amount"
              class="w-full border border-[#E4E4E4] rounded-lg px-4 py-2 focus:outline-none focus:border-primary"
              :placeholder="$t('LABELS.enterAmount')"
            />
          </div>
